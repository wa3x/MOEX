...
Приложение написано на Python + PyQt6 и предназначено для быстрого локального мониторинга бумаг MOEX без браузерного терминала. Виджет показывает актуальную цену (без подписки +15 минут), изменение на выбранном диапазоне и интерактивный свечной график.
